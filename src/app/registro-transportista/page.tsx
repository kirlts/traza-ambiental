...
export default function RegistroTransportistaPage() {
  ...
  const handleSubmit = async (e: ReturnType<typeof JSON.parse>) => {
    ...
    try {
      const response = await fetch("/api/auth/register/transportista", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          capacidadProcesamiento: parseFloat(formData.capacidadProcesamiento) || undefined,
          patenteVehiculoPrincipal: formData.patenteVehiculoPrincipal || undefined,
        }),
      });
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Tu cuenta ha sido creada. Revisa tu email para verificar la cuenta y obtener
              instrucciones sobre cómo subir tu documentación.
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Regístrate como Transportista en la plataforma de Gestión de Neumáticos
        </p>
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>Autorización Sanitaria de Transporte</li>
                  <li>Permiso de Circulación</li>
                  <li>Revisión Técnica de vehículos</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Opcional - capacidad de procesamiento de neumáticos
                  </p>
                </div>

                <div>
                  <label
                    htmlFor="patenteVehiculoPrincipal"
                    className="block text-sm font-medium text-gray-700"
                  >
                    Patente vehículo principal
                  </label>
                  <input
                    id="patenteVehiculoPrincipal"
                    name="patenteVehiculoPrincipal"
                    type="text"
                    value={formData.patenteVehiculoPrincipal}
                    onChange={handleChange}
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    placeholder="AB-123 o AB1234"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Opcional - patente del vehículo principal de transporte
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              >
                {isLoading ? "Creando cuenta..." : "Crear Cuenta Transportista"}
              </button>
            </div>
          </form>
