...
export default function TransportistaForm({ onBack }: TransportistaFormProps) {
  ...
  return (
    <div className="w-full">
      <div className="flex items-center mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Registro Transportista</h2>
          <p className="text-sm text-gray-500">Completa tus datos para unirte como Transportista</p>
        </div>
      </div>
