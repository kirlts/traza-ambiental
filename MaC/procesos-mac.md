...
Javiera tiene treinta y dos años y lleva cuatro trabajando como diseñadora independiente. Es buena en lo que hace, consigue proyectos, los entrega. Pero cada lunes siente que empieza desde cero: no recuerda bien en qué quedó el viernes, tiene tres clientes activos con estados distintos en su cabeza, y la sensación de que algo importante siempre está a punto de caerse.

Un colega le habla de MaC. Ella no quiere un sistema complejo. Empieza por lo mínimo: una nota semanal donde anota qué hizo y qué fue distinto a lo esperado. Nada más. La llama "bitácora" porque suena menos solemne que "reporte".

La primera semana descubre que pasó doce horas en un proyecto que tenía presupuestado en ocho. No lo sabía. Lo había sentido vagamente, pero verlo escrito es diferente. No toma ninguna decisión todavía, solo lo anota.

La segunda semana anota que el cliente más exigente siempre pide cambios el día viernes a las seis de la tarde. También lo anota.
...
Esto es Priorizar, aunque ella todavía no lo llama así.

También empieza a Descomponer sin darse cuenta: cuando escribe "avanzar propuesta para Fundación X", se obliga a escribir qué significa eso concretamente. Resulta que significa cuatro cosas distintas, y una de ellas depende de que el cliente le mande información que aún no llegó. Antes eso lo hubiera descubierto el miércoles. Ahora lo sabe el lunes.
...
También nota algo más: lleva tres viernes seguidos sin completar las tareas de producción del día. Siempre pasa algo. Decide que los viernes son solo para cerrar, registrar y dejar el lunes listo. Otra entrada en Decisiones.
...
Javiera trabaja principalmente en Notion para sus notas y en GitHub para entregar archivos a desarrolladores con quienes colabora ocasionalmente. Sus clientes usan correo. Ella usa calendario de Google.

Configura un agente simple que, cada viernes a las cinco de la tarde, cruza su calendario de la semana, los cambios en sus carpetas de proyecto y los correos marcados como importantes, y le entrega un borrador de bitácora: qué reuniones tuvo, qué archivos entregó, qué correos recibieron respuesta y cuáles no. El borrador llega a Notion con campos vacíos donde el agente no pudo inferir nada.

La primera semana el borrador está 60% lleno. Javiera completa el resto en cinco minutos en lugar de los quince habituales. La segunda semana está al 70%. Al mes, Javiera solo escribe las cosas que ocurrieron fuera del sistema: la conversación con un cliente en un café, la idea que tuvo caminando, la decisión informal que tomó por teléfono.
...
No tiene un sistema complejo. Tiene:

- Una Identidad de media página que no cambia seguido pero orienta todo.
- Una Dirección con tres objetivos para el semestre, revisados trimestralmente.
- Una Capacidad anotada en dos párrafos: sus restricciones reales, sus puntos únicos de falla.
- Una planificación semanal que el agente propone y ella ajusta en diez minutos.
- Tareas descompuestas y con dependencias visibles antes de que empiece el ciclo.
- Una bitácora que el agente llena en un 70% y ella completa con lo que no dejó rastro.
- Un log de decisiones con diecisiete entradas, algunas ya consolidadas en políticas.
- Un agente que monitorea patrones y le hace preguntas cuando detecta algo.
