  ...
  [941],
  {
        ...
        return (function (e, t) {
          ...
          for (const t in e)
            "default" !== t &&
              ...
              ((s = (i = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) &&
              (s.get || s.set)
                ? i(o, t, s)
                : (o[t] = e[t]));
          return o;
    ...
    1506: (e, t, r) => {
      ...
      e.exports = function (e, t, r) {
        ...
        if (k) g = e.iterator;
          ...
          if (a(m)) {
            for (v = 0, y = c(e); y > v; v++) if ((_ = callFn(e[v])) && l(f, _)) return _;
            return new Result(!1);
          }
          g = u(e, m);
        }
      ...
      n(
        { target: "Iterator", proto: !0, real: !0, forced: m },
        {
          filter: function filter(e) {
            ...
            return g ? i(g, this, e) : new v(a(this), { predicate: e });
          },
        }
      );
    },
      ...
      t.DashboardUtils = {
        isElementorPage() {
          ...
          return document.body.className
            .split(" ")
            .some(
              (e) => e.includes("elementor") && (e.includes("page") || e.includes("post-type"))
            );
        },
      };
    },
    ...
    3617: (e, t, r) => {
      ...
      (p(f, _) || defineIteratorPrototypeAccessor(_, y),
        (!S && p(f, v) && f[v] !== Object) || defineIteratorPrototypeAccessor(v, E),
        (E.prototype = f),
    ...
    3827: (e, t, r) => {
      ...
      const c = 18e5,
        ...
        u = (t.SCREEN_TYPES = { TAB: "tab", POPUP: "popup", APP_SCREEN: "app_screen" });
      class WpDashboardTracking {
        ...
        static init() {
          ...
          ((this.canSendEvents = e.can_send_events || !1),
        ...
        static checkSessionTimeout() {
          Date.now() - this.lastActivityTime > c &&
            !this.sessionEnded &&
        ...
        static trackActionControl(e, t) {
          this.updateActivity();
          const r = { wpdash_action_control_interacted: e, wpdash_control_type: t };
        ...
        static destroy() {
          (this.activityCheckInterval && clearInterval(this.activityCheckInterval),
            (this.initialized = !1));
        }
      }
      ...
      n(
        { target: "Iterator", proto: !0, real: !0, forced: m },
        {
          map: function map(e) {
            ...
            return g ? i(g, this, e) : new v(a(this), { mapper: e });
          },
        }
      );
    },
    ...
    5454: (e, t, r) => {
      ...
      t.AppsEventTracking = class AppsEventTracking {
        ...
        static sendExportKitCustomization(e) {
          return this.dispatchEvent(a, { trigger: i.default.triggers.click, ...e });
        }
        static sendImportKitCustomization(e) {
          return this.dispatchEvent(c, { trigger: i.default.triggers.click, ...e });
        }
        static sendKitImportStatus(e = null) {
          return this.dispatchEvent(l, {
            kit_import_status: !e,
            ...(e && { kit_import_error: e.message }),
          });
        }
        ...
        static sendImportExportAdminAction(e) {
          return this.dispatchEvent(p, { trigger: i.default.triggers.click, action_type: e });
        }
      ...
      t.default = class NavigationTracking {
        ...
        static determineNavArea(e) {
          if (e.closest("li.menu-top")) {
            if (e.closest(o)) {
              return e.closest(a).classList.contains("wp-not-current-submenu")
                ? n.NAV_AREAS.HOVER_MENU
                : n.NAV_AREAS.SUBMENU;
            }
    ...
    7670: (e, t, r) => {
      ...
      class ScreenViewTracking {
        ...
        static init() {
          i.DashboardUtils.isElementorPage() &&
            (this.trackInitialPageView(), this.attachTabChangeTracking());
        }
        ...
        static getScreenData() {
          ...
          return { screenId: l, screenType: u };
        }
        static getScreenIdFromBody() {
          const e = document.body.className.split(" ");
          for (const t of e)
            if (t.startsWith("elementor") && (t.includes("page") || t.includes("post-type")))
              return t;
        ...
        static attachNavTabTracking() {
          ...
          }).observe(e, { attributes: !0, attributeFilter: ["class"], subtree: !0, childList: !0 });
        }
        ...
        static trackScreen(e, t = n.SCREEN_TYPES.APP_SCREEN) {
          ...
          this.trackedScreens.has(r) ||
            (this.trackedScreens.add(r), n.default.trackScreenViewed(e, t));
        }
      }
      ...
      t.BaseRegistry = class BaseRegistry {
        ...
        getAll() {
          return Array.from(this.sections.values())
            ...
            .map((e) =>
              e.children ? { ...e, children: [...e.children].sort((e, t) => e.order - t.order) } : e
            )
    ...
    8064: (e, t, r) => {
      ...
      t.default = class ActionControlTracking {
        ...
        static isExcludedElement(e) {
          for (const t of Object.values(s)) if (e.closest(t)) return !0;
          return !1;
        }
          ...
          (document.addEventListener(
            ...
            (e) => {
              ...
              if (r && !this.isExcludedElement(r))
                return void this.trackControl(r, n.CONTROL_TYPES.BUTTON);
              const i = t.closest("a");
              !i ||
                this.isExcludedElement(i) ||
                this.isNavigationLink(i) ||
                this.trackControl(i, n.CONTROL_TYPES.LINK);
            },
            { capture: !1 }
          ),
            document.addEventListener("change", (e) => {
              ...
              if (!t) return;
              const r = t.closest(
                '.elementor-control-type-switcher input, [role="switch"], .toggle-control input'
              );
              if (r && !this.isExcludedElement(r))
                return void this.trackControl(r, n.CONTROL_TYPES.TOGGLE);
              const i = t.closest('input[type="checkbox"]');
              if (i && !this.isExcludedElement(i))
                return void this.trackControl(i, n.CONTROL_TYPES.CHECKBOX);
              const s = t.closest('input[type="radio"]');
              if (s && !this.isExcludedElement(s))
                return void this.trackControl(s, n.CONTROL_TYPES.RADIO);
        ...
        static extractControlData(e, t) {
          ...
          s && (r.name = s);
          let o = "";
          if (n.CONTROL_TYPES.BUTTON === t)
            o = e.value || e.textContent.trim() || e.getAttribute("aria-label");
          else if (n.CONTROL_TYPES.LINK === t)
            o = e.textContent.trim() || e.getAttribute("aria-label") || e.getAttribute("title");
          else if (n.CONTROL_TYPES.SELECT === t) {
            const t = e.options[e.selectedIndex];
            o = t ? t.textContent.trim() : "";
          } else if (
            n.CONTROL_TYPES.CHECKBOX === t ||
            n.CONTROL_TYPES.TOGGLE === t ||
            n.CONTROL_TYPES.RADIO === t
          ) {
          ...
          if (a && "string" == typeof a) {
            const e = a
              .split(" ")
              .filter((e) => e && !e.startsWith("elementor-control-") && !e.startsWith("wp-"))
              .slice(0, 3);
